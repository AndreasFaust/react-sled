...
var StateProvider = function (_a) {
    ...
    return (React__default.createElement(StateContext.Provider, { value: value }, children));
};

var Sled = function (props) {
    var children = props.children;
    return (React__default.createElement(StateProvider, { reducer: reducer, initialState: initialState }, children));
};

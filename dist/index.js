...
function useGesture(handlers, config) {
  ...
  var gestureController = React__default.useRef();
...
var SledSpring = function SledSpring(_ref) {
  ...
  return React__default.createElement(reactSpring.animated.div, _extends({}, bind ? bind() : {}, {
    className: "sled-view",
    ref: springRef,
    style: {
      position: 'absolute',
...
var SledViews = function SledViews(_ref) {
  ...
  return React__default.createElement(StyledDiv, {
    ...
    cssHeight: cssHeight,
    tabIndex: 0
  }, React__default.createElement(SledSprings, {
